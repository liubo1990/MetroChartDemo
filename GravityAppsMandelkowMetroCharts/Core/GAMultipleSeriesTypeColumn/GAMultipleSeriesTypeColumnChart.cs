namespace GravityAppsMandelkowMetroCharts
{
    ...
    /// </summary>
    public class GAMultipleSeriesTypeColumnChart : ChartBase
    {
        #region Fields
        ...
        /// </summary>
        static GAMultipleSeriesTypeColumnChart()        
        {
#if NETFX_CORE
...
#else
            DefaultStyleKeyProperty.OverrideMetadata(typeof(GAMultipleSeriesTypeColumnChart), new FrameworkPropertyMetadata(typeof(GAMultipleSeriesTypeColumnChart)));
#endif
        }
        ...
        /// </summary>
        public GAMultipleSeriesTypeColumnChart()
        {
#if NETFX_CORE
