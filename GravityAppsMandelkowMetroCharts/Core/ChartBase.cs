namespace GravityAppsMandelkowMetroCharts
{
    ...
    public abstract class ChartBase : Control, INotifyPropertyChanged
    {
        ...
        private bool _isGAMultipleSeriesChart;
        ...
        public ChartBase()
        {
            string chartType = this.GetType().ToString();
            _isGAMultipleSeriesChart = (chartType.Substring(chartType.LastIndexOf('.') + 1) == "GAMultipleSeriesTypeColumnChart");
       ...
       public bool HasExceptions
        ...
        /// <summary>
        /// Copy the end next points start value into the current points end value
        /// </summary>
        ...
        /// <summary>
        /// update the colours on the data points.
        /// For multiple series charts only update the colour at the end of the series
        /// </summary>
