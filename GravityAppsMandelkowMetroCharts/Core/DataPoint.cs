namespace GravityAppsMandelkowMetroCharts
{
    ...
    public class DataPoint : DependencyObject, INotifyPropertyChanged
    {
        ...
        //GA endValue is the value of the next data point for use in drawing line graph
        ...
        /// <summary>
        /// Contains the absolute StartValue of the NEXT item 
        /// </summary>
        ...
        public double ? EndPercentageFromMaxDataPointValue
        {
            get
            {
                if (EndValue.HasValue)
                {
                    if (MaxDataPointValue > 0)
                    {
                        return EndValue / MaxDataPointValue;
                    }
                    return 0.0;
                }
                else
        ...
        private void UpdatePercentage()
        {
            RaisePropertyChangeEvent("PercentageFromMaxDataPointGroupSum");
            RaisePropertyChangeEvent("PercentageFromMaxDataPointValue");
            RaisePropertyChangeEvent("EndPercentageFromMaxDataPointValue");
